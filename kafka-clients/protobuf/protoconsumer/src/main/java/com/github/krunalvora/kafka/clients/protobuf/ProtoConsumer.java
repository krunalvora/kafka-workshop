package com.github.krunalvora.kafka.clients.protobuf;
...
import com.github.krunalvora.Event1OuterClass.Event1;
...
public class ProtoConsumer {
  ...
  public static void main(String[] args) {
    ...
    KafkaConsumer<String, Event1> consumer = new KafkaConsumer<>(properties);
    consumer.subscribe(Collections.singleton(topic));


    while (true) {
      ConsumerRecords<String, Event1> records = consumer.poll(Duration.ofMillis(100));
      for (ConsumerRecord<String, Event1> record : records) {
